...
def readArray(arr, pathPrefix:str, ext:str, expextedSize=None):
    ...
    ind = 0
    arrInd = 0
    while os.path.exists(pathPrefix + str(ind) + ext):
...
def dumpArray(arr, pathPrefix:str, ext:str, blockSize =1024 * 1024 * 512):
